...
/**
 * Rights for the placeholder media.
 *
 * These files were generated by the House (`scripts/generate-placeholder-media.mjs`), so
 * the House is genuinely their rights holder and can say so. They are the one honest
 * exception to the pessimistic default: a real record starts at `not-established` and
 * stays there until a human records permission or a licence (docs/rights.md).
 */
const DEMO_RIGHTS: NonNullable<ArtworkInput['rights']> = {
  displayRightsStatus: 'display-and-rehost',
  copyrightOwner: 'House of Nucci (generated placeholder asset)',
  highResRehostingAllowed: true,
  derivativesAllowed: true,
  commercialUseAllowed: false,
  publicationBasis: 'owner-created',
  permissionEvidence:
    'Generated by scripts/generate-placeholder-media.mjs. Not an artwork, and no third-party rights are involved.',
  notes:
    'Placeholder media created by the House. When real works replace these records, rights begin at not-established.',
};
